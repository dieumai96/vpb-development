import { SUPPORT_NOW_SEGEMENT_TYPE, SUPPORT_NOW_GET_NO_TYPE_SUCCESS, SUPPORT_NOW_GET_NO_TYPE_FAIL, SUPPORT_NOW_GET_HAS_TYPE_SUCCESS, SUPPORT_NOW_GET_MENU_SUCCESS, SUPPORT_NOW_RESET_SEGMENT, SUPPORT_NOW_ADD_TAG, SUPPORT_NOW_REMOVE_TAG, SUPPORT_NOW_UPDATE_MENU_CHECKBOX_STATE } from "./support-now.type";
...
export const actUpdateMenuCheckboxState = (data) => {
  return {
    type: SUPPORT_NOW_UPDATE_MENU_CHECKBOX_STATE,
    payload: data,
  }
}
