      ...
      <div className="container">
        ...
        <div className="nav-tab promotion--tab promotion--menu-collapse">
          ...
          <div className="nav-tab__content promotion-tab-content">
            ...
            <div className="promotion2 tab-pane animated" id="promotion2">
              <div className="row">
                <div className="col-lg-8 promotion-wrap__left">
                  <div className="promotion-slide" data-slick="{&quot;autoplay&quot;: true, &quot;autoplaySpeed&quot;: 3000}">
                    <a className="promotion-item promotion-item--main" href="#" data-index="GAWKLGDJKNGJKSNEGJKSNEGSE">
                      <picture>
                        <source media="(max-width: 767px)" srcSet="/images/promotion-item.jpg" /><img src="/images/promotion-item.jpg" alt="" /></picture>
                      <div className="promotion-item__content"><span className="promotion-item--tag">Limited time</span>
                        <div className="promotion-item--wishlist"><input id="checkbox7" type="checkbox" /><label htmlFor="checkbox7">Travel</label></div>
                        <h5 className="promotion-item--title">Lorem ipsum dolor sit amet, consectetur</h5>
                      </div>
                    </a>
                    <a className="promotion-item promotion-item--main" href="#" data-index="4VA223fwDAvfvfvfvfvfWIOJDAWMDKAWMDKLMDKLWMDKAMDKAW">
                      <picture>
                        <source media="(max-width: 767px)" srcSet="/images/promotion-item.jpg" /><img src="/images/promotion-item.jpg" alt="" /></picture>
                      <div className="promotion-item__content">
                        <div className="promotion-item--tag">Limited time</div>
                        <div className="promotion-item--wishlist"><input id="checkbox8" type="checkbox" /><label htmlFor="checkbox8">Travel</label></div>
                        <h5 className="promotion-item--title">Lorem ipsum dolor sit amet, consectetur</h5>
                      </div>
                    </a>
                  </div>
                ...
                <div className="col-lg-4 promotion-wrap__right">
                  <div className="promotion-wrap__right_content" id="scroll">
                    <a className="promotion-item" href="#" data-index="4VAD2222222AvfvfvfvfvfWIOJDAWMDKAWMDKLMDKLWMDKAMDKAW">
                      <picture>
                        <source media="(max-width: 767px)" srcSet="/images/promotion-item.jpg" /><img src="/images/promotion-item.jpg" alt="" /></picture>
                      <div className="promotion-item__content"><span className="promotion-item--tag">Limited time</span>
                        <div className="promotion-item--wishlist"><input id="checkbox9" type="checkbox" /><label htmlFor="checkbox9">Travel</label></div>
                        <h5 className="promotion-item--title">Lorem ipsum dolor sit amet, consectetur</h5>
                      </div>
                    </a>
                    <a className="promotion-item" href="#" data-index="4VADAvfvfvfvfvfWIO232tggrgrgrJDAWMDKAWMDKLMDKLWMDKAMDKAW">
                      <picture>
                        <source media="(max-width: 767px)" srcSet="/images/promotion-item.jpg" /><img src="/images/promotion-item.jpg" alt="" /></picture>
                      <div className="promotion-item__content"><span className="promotion-item--tag">Limited time</span>
                        <div className="promotion-item--wishlist"><input id="checkbox10" type="checkbox" /><label htmlFor="checkbox10">Travel</label></div>
                        <h5 className="promotion-item--title">Lorem ipsum dolor sit amet, consectetur</h5>
                      </div>
                    </a>
                    <a className="promotion-item" href="#" data-index="4okkkkvfvfvfvfvfWIOJDAWMDKAWMDKLMDKLWMDKAMDKAW">
                      <picture>
                        <source media="(max-width: 767px)" srcSet="/images/promotion-item.jpg" /><img src="/images/promotion-item.jpg" alt="" /></picture>
                      <div className="promotion-item__content"><span className="promotion-item--tag">Limited time</span>
                        <div className="promotion-item--wishlist"><input id="checkbox11" type="checkbox" /><label htmlFor="checkbox11">Travel</label></div>
                        <h5 className="promotion-item--title">Lorem ipsum dolor sit amet, consectetur</h5>
                      </div>
                    </a>
                    <a className="promotion-item" href="#" data-index="4VADAvfvfvfvfvfWIOJDAWMDKAWMDKLMDK22222222LWMDKAMDKAW">
                      <picture>
                        <source media="(max-width: 767px)" srcSet="/images/promotion-item.jpg" /><img src="/images/promotion-item.jpg" alt="" /></picture>
                      <div className="promotion-item__content"><span className="promotion-item--tag">Limited time</span>
                        <div className="promotion-item--wishlist"><input id="checkbox12" type="checkbox" /><label htmlFor="checkbox12">Travel</label></div>
                        <h5 className="promotion-item--title">Lorem ipsum dolor sit amet, consectetur</h5>
                      </div>
                    </a>
                  </div>
            ...
            <div className="promotion3 tab-pane animated" id="promotion3">
              <p>promation content 3</p>
            </div>
            <div className="promotion4 tab-pane animated" id="promotion4">
              <p>promation content 4</p>
            </div>
            <div className="promotion5 tab-pane animated" id="promotion5">
              <p>promation content 5</p>
            </div>
            <div className="promotion6 tab-pane animated" id="promotion6">
              <p>promation content 6</p>
            </div>
            <div className="promotion7 tab-pane animated" id="promotion7">
              <p>promation content 7</p>
            </div>
            <div className="promotion8 tab-pane animated" id="promotion8">
              <p>promation content 8</p>
            </div>
            <div className="promotion9 tab-pane animated" id="promotion9">
              <p>promation content 9</p>
            </div>
            <div className="promotion10 tab-pane animated" id="promotion10">
              <p>promation content 10</p>
            </div>
          </div>
        </div>
      </div>
